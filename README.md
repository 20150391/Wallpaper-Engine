...
The .exe, or, installer file is coming if you <em>want</em> to download it, but it's probably easier to just download it now, I'll also put in ALL the bgs:)
  ...
  <p>
  It is <em>suggested</em> that you install the lively wallpaper app <strong>before</strong> running npm start. This is to make your <em>experience</em> better overall. This is because, it can become <em>slower</em> if you don't install lively <em>before</em> you run npm start. <pre><code>npm start</code></pre>
  </p>
